...
* Description: Adiciona dois tipos de produtos: cartões simples e cartões personalizados
* Author: Ana Amélia Mendes Galvão
...
echo '<span style="padding-left: 10px">Tamanhos disponíveis: </span>';
    ...
    'value'       => get_post_meta( get_the_ID(), '_tuna_card_size_pp_checkbox' )[0],
    'description' => __( 'Tamanho PP', 'woocommerce' ),
    ) );
      woocommerce_wp_checkbox( array(
        'id'          => '_tuna_card_size_p_checkbox',
        'value'       => get_post_meta( get_the_ID(), '_tuna_card_size_p_checkbox' )[0],
        'description' => __( 'Tamanho P', 'woocommerce' ),
      ) );
    woocommerce_wp_checkbox( array(
      'id'          => '_tuna_card_size_m_checkbox',
      'value'       => get_post_meta( get_the_ID(), '_tuna_card_size_m_checkbox' )[0],
      'description' => __( 'Tamanho M', 'woocommerce' ),
      ) );
      woocommerce_wp_checkbox( array(
      'id'          => '_tuna_card_size_g_checkbox',
      'value'       => get_post_meta( get_the_ID(), '_tuna_card_size_g_checkbox' )[0],
